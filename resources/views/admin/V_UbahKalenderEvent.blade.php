    ...
    <div class="bg-white shadow-lg rounded-xl w-full max-w-xl p-6 relative">
      ...
      <!-- FORM MULAI -->
        ...
        <div>
          ...
          <input type="text" name="judul_konten" value="{{ old('judul_konten', $event->judul_event) }}" placeholder="Masukkan judul event anda, maksimal 120 karakter"
        ...
        <div class="flex flex-col md:flex-row gap-4">
          <div class="flex-1">
           ...
           <input type="date" name="tanggal" value="{{ old('tanggal', $event->tanggal_event) }}" class="mt-1 w-full border border-gray-300 rounded p-2" required>
          </div>
          <div class="flex-1">
            <label class="block text-sm font-semibold">Jam*</label>
            <input type="time" name="jam" value="{{ old('jam', $event->waktu_event) }}" class="mt-1 w-full border border-gray-300 rounded p-2" required>
          </div>
        </div>
